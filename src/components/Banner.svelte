...
>
    <div class="fixed inset-x-0 bottom-0 z-50 pb-3 select-none sm:pb-5">
        <div class="px-3 mx-auto max-w-screen-xl sm:px-6 lg:px-8">
            <div class="p-2 bg-green-600 rounded-lg shadow-lg sm:p-3">
                <div class="flex flex-wrap items-center justify-between">
                    <div class="flex items-center flex-1 w-0">
                        {#if hasIcon}
                            <span class="p-2 text-white bg-green-800 rounded-lg">
                                <slot name="icon">
                    ...
                    <div class="flex-shrink-0 order-2 sm:order-3 sm:ml-2">
                        <button
                            ...
                            class="p-2 rounded-md hover:bg-green-400 focus:outline-none focus:bg-green-400 transition ease-in-out duration-150">
                            <svg class="w-6 h-6 text-white" stroke="currentColor" fill="none" viewBox="0 0 24 24">
